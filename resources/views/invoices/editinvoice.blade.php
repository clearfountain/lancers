...
@section('content')
      ...
      <button type="button" class="btn btn-sm editInvoice " data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;EDIT INVOICE</button>
...
@section('styles')
    <style>
        ...
        * {
        ...
        .colorContainer, .sampleContainer{
                    display: flex;
                    flex-direction: row;
                }
                .sampleContainer{
