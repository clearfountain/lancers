        ...
        <div class="section1">
            ...
            <div id="bill">
                ...
                <div class="hours">
                    ...
                    <i class="fa fa-calendar start"><input type="text" onfocus="(this.type='date')" name="start" placeholder=" Set start date" /></i>
                    <i class="fa fa-calendar end"><input type="text" onfocus="(this.type='date')" name="end" placeholder="Set end date" /></i>
                </div>
